...
#  @smoke
  Scenario Outline: AskOmDch Place Order As a Guest Pay with Direct Bank Transfer
...
#  @smoke
  Scenario Outline: AskOmDch Place Order As a Guest and Create Account Pay with Direct Bank Transfer
    Given user is on the homepage
    Then user should be able to click store link
    And user should be able to enter product name "<product_item>" in search field and click search button
    Then user should be able to verify search result "<product_item>"
...
#  @smoke
  Scenario Outline: AskOmDch Place Order As a Guest with different address for delivery Pay with Direct Bank Transfer
    Given user is on the homepage
    Then user should be able to click store link
    And user should be able to enter product name "<product_item>" in search field and click search button
    Then user should be able to verify search result "<product_item>"
...
#      @smoke
  Scenario Outline: AskOmDch Place Order As a Guest with Different Address for Delivery with Create an Account Pay with Direct Bank Transfer
    Given user is on the homepage
    Then user should be able to click store link
    And user should be able to enter product name "<product_item>" in search field and click search button
    Then user should be able to verify search result "<product_item>"
...
#      @smoke
  Scenario Outline: AskOmDch Place Order As a Guest and Pay with Cash on Delivery
    Given user is on the homepage
    Then user should be able to click store link
    And user should be able to enter product name "<product_item>" in search field and click search button
    Then user should be able to verify search result "<product_item>"
    ...
    Examples:
      ...
      |Ken        |Bee       |Ken INC       |United States (US)       |358 N Palatine rd|apt#123          |Chicago|NC     |50008     |99999999|KenBee@gmail.com |jeans       |Basic Blue Jeans    |
        ...
        #  @smoke
  Scenario Outline: AskOmDch Place Order As a Guest and Create Account Pay with Cash on Delivery
    Given user is on the homepage
    Then user should be able to click store link
    And user should be able to enter product name "<product_item>" in search field and click search button
    Then user should be able to verify search result "<product_item>"
    ...
    #      @smoke
  Scenario Outline: AskOmDch Place Order As a Guest with different address for delivery with create an account Pay with Cash on Delivery
    Given user is on the homepage
    Then user should be able to click store link
    And user should be able to enter product name "<product_item>" in search field and click search button
    Then user should be able to verify search result "<product_item>"
  ...
  @smoke
  Scenario Outline: AskOmDch Place Order As a Guest and Choose Random Payment Method
    Given user is on the homepage
    Then user should be able to click store link
    And user should be able to enter product name "<product_item>" in search field and click search button
    Then user should be able to verify search result "<product_item>"
